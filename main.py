...
df_codigos = pd.read_excel('data/catalogo_codigo_postal.xlsx', header=None, names=head_cols)
...
st.metric('El código postal válido más cercano es', closest_value, delta=None, delta_color="normal")
